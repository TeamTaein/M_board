...
<a href="#" onclick="ocultar_login_sign_up()"><i class="material-icons">&#xE5C4;</i></a>
    ...
    <br /><br />
     <h2>SIGN UP</h2><br />
<input type="text" placeholder="Email" name="email" value="${param.email}" />
<c:if test="${not empty errors.email}"><script type="text/javascript">alert('이메일을 입력해주세요');</script></c:if>
<input type="text" placeholder="User" name="name" value="${param.name}" />
<c:if test="${not empty errors.name}"><script type="text/javascript">alert('이름을 입력해주세요');</script></c:if>
<input type="password" placeholder="Password" name="password" value="${param.password}" />
<c:if test="${not empty errors.password}"><script type="text/javascript">alert('비밀번호을 입력해주세요');</script></c:if>
<input type="password" placeholder="Confirm Password" name="confirmPassword" value="${param.confirmPassword}" />
<c:if test="${not empty errors.conformPassword}"><script type="text/javascript">alert('비밀번호를 다시 입력해주세요');</script></c:if>
<input type="text" placeholder="nickname" name="id" value="${param.id}"/><br />
<c:if test="${not empty errors.id}"><script type="text/javascript">alert('닉네임을 입력해주세요');</script></c:if>
